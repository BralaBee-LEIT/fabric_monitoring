...
def create_activity(activity_id, item_id, start_time, status, end_time=None, 
                   duration_seconds=0, submitted_by="test@example.com"):
...
class TestSmartMerge:
    ...
    def test_merge_no_jobs(self, pipeline):
        ...
        activities = [
            create_activity("act_001", "item_001", "2024-01-15T10:00:00Z", "Succeeded",
    ...
    def test_merge_correlates_by_item_id_and_time(self, pipeline):
        ...
        detailed_jobs = [
            create_job("job_001", "item_001", "2024-01-15T10:01:00Z", "Succeeded", 
    ...
    def test_merge_updates_failed_status(self, pipeline):
        ...
        detailed_jobs = [
            create_job("job_001", "item_001", "2024-01-15T10:00:30Z", "Failed",
                      failure_reason="Timeout exceeded", end_time="2024-01-15T10:05:00Z")
        ]
    ...
    def test_merge_fills_missing_end_time(self, pipeline):
        ...
        detailed_jobs = [
            create_job("job_001", "item_001", "2024-01-15T10:00:00Z", "Succeeded",
    ...
    def test_merge_does_not_correlate_outside_window(self, pipeline):
        ...
        detailed_jobs = [
            create_job("job_001", "item_001", "2024-01-15T10:10:00Z", "Succeeded",
                      end_time="2024-01-15T10:20:00Z")  # 10 min later - outside window
        ]
    ...
    def test_merge_different_items_not_matched(self, pipeline):
        ...
        detailed_jobs = [
            create_job("job_001", "item_002", "2024-01-15T10:00:00Z", "Failed",
                      failure_reason="Error")  # Different item
        ]
...
class TestSmartMergeEdgeCases:
    ...
    def test_merge_handles_null_timestamps(self, pipeline):
        ...
        activities = [
            create_activity("act_001", "item_001", None, "Unknown")
        ]
        detailed_jobs = [
            create_job("job_001", "item_001", "2024-01-15T10:00:00Z", "Succeeded")
        ]
    ...
    def test_merge_handles_invalid_dates(self, pipeline):
        ...
        activities = [
            create_activity("act_001", "item_001", "not-a-date", "Unknown")
        ]
    ...
    def test_merge_multiple_activities_multiple_jobs(self, pipeline):
        ...
        detailed_jobs = [
            ...
            create_job("job_002", "item_002", "2024-01-15T11:00:30Z", "Failed",
