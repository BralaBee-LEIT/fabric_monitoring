...
class CSVExporter:
    ...
    def export_daily_activities(self, activities: List[Dict[str, Any]], 
                              date: datetime, custom_suffix: str = None) -> str:
    ...
    def export_activity_summary(self, activities: List[Dict[str, Any]], 
                              date: datetime, custom_suffix: str = None) -> str:
    ...
    def _normalize_activities_data(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        standard_columns = [
            'Id', 'Activity', 'ActivityId', 'ItemName', 'ItemType',
            'ItemId', 'WorkspaceId', 'WorkspaceName', 'UserId', 'UserKey',
            'SubmittedBy', 'CreatedBy', 'LastUpdatedBy',
            'CreationTime', 'StartTime', 'EndTime', 'CompletionTime', 'Status',
            'Duration', 'DurationMs', 'DurationSeconds', 'RecordType', 'UserType',
            'UserAgent', 'ClientIP', 'ObjectUrl', 'Domain', 'Location',
            '_workspace_id', '_workspace_name', '_extraction_date'
        ]
