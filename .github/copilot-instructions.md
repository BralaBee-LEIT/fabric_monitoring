...
**Version**: 0.3.18 (January 2026) | **Library-first** Microsoft Fabric monitoring/governance toolkit.
...
## Lineage Explorer (`src/usf_fabric_monitoring/lineage_explorer/`)

Interactive web visualization for Microsoft Fabric data lineage.

### Quick Start
```bash
# Start the server (loads from exports/lineage/*.csv)
make lineage-explorer
# OR: conda run -n fabric-monitoring python run_lineage_explorer.py
...
Organized into 8 numbered folders:
...
- `04_API_Guides/` - API documentation (placeholder)
