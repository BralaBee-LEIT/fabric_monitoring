...
class FabricWorkspaceMonitor:
    ...
    def get_workspace_inventory(self) -> list[dict[str, Any]]:
        ...
        # Get all workspaces
        response = requests.get("https://api.fabric.microsoft.com/v1/workspaces", headers=headers, timeout=30)
        ...
        for ws in workspaces:
            ...
            try:
                items_response = requests.get(
                    f"https://api.fabric.microsoft.com/v1/workspaces/{ws['id']}/items", headers=headers, timeout=15
                )
...
def main():
    ...
    parser.add_argument(
        "--output-dir", type=str, default="./exports/workspace_reports", help="Output directory for report files"
    )
    parser.add_argument(
