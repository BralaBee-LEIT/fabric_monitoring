...
def run_item_details_extraction(
    workspace_id: str = None, output_dir: str = "exports/fabric_item_details", log_level: str = "INFO"
) -> dict[str, Any]:
    """
...
def main(argv=None):
    ...
    result = run_item_details_extraction(
        workspace_id=args.workspace, output_dir=args.output_dir, log_level=args.log_level
    )
