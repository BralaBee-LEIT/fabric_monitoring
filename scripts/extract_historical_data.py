    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            TimedRotatingFileHandler(
                "logs/historical_extraction.log", when="midnight", interval=1, backupCount=30, encoding="utf-8"
            ),
        ],
    )
...
Examples:
  ...
  python extract_historical_data.py --days 7 --workspace-ids ws1,ws2,ws3
    ...
    parser.add_argument("--days", type=int, help=f"Number of days back from today to extract (max {max_days})")
    ...
    parser.add_argument("--workspace-ids", type=str, help="Comma-separated list of workspace IDs to filter")

    parser.add_argument("--activity-types", type=str, help="Comma-separated list of activity types to filter")
